                                        ...
                                        <div class="col-sm-6 offset-sm-3 text-center slider-text">
                                            <div class="slider-text-inner">
                                                <div class="desc">
                                                    ...
                                                    <!---  chamar o produto passando o id. ajustar método -->
                                                    <p><a href="{{ route('product_detail') }}" class="btn btn-primary">Shop Collection</a></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-sm-6 text-center">
                                <div class="featured">
                                    <!---  chamar o produto passando o id. ajustar método -->
                                    <p><a href="{{ route('product_detail') }}"class="featured-img" style="background-image: url(images/men.jpg);"></a>
                                    <div class="desc">
                                        <h2>    <!---  chamar o produto passando o id. ajustar método -->
                                            <p><a href="{{ route('product_detail') }}">Shop Men's Collection</a></h2>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6 text-center">
                                <div class="featured">
                                    <!---  chamar o produto passando o id. ajustar método -->
                                    <p><a href="{{ route('product_detail') }}" class="featured-img" style="background-image: url(images/women.jpg);"></a>
                                    <div class="desc">
                                        <h2>    <!---  chamar o produto passando o id. ajustar método -->
                                    <p><a href="{{ route('product_detail') }}">Shop Women's Collection</a></h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="colorlib-product">
                    <div class="container">
                        ...
                        <div class="row row-pb-md">
                            <!-- aqui será um método listar produtos com 12 itens por pagina
                            originado do método index, search, woman e man

                             -->
                            <div class="col-lg-3 mb-4 text-center">
                                <div class="product-entry border">
                                    <!---  chamar o produto passando o id. ajustar método -->
                                    <p><a href="{{ route('product_detail') }}" class="prod-img">
                                        <img src="images/item-1.jpg" class="img-fluid" alt="Free html5 bootstrap 4 template">
                                    </a>
                                    <div class="desc">
                                        <h2>    <!---  chamar o produto passando o id. ajustar método -->
                                            <p><a href="{{ route('product_detail') }}">Women's Boots Shoes Maca</a></h2>
                            ...
                            <div class="col-lg-3 mb-4 text-center">
                                <div class="product-entry border">
                                    ...
                                    <div class="desc">
                                        <h2>    <!---  chamar o produto passando o id. ajustar método -->
                                            <p><a href="{{ route('product_detail') }}">Women's Minam Meaghan</a></h2>
                                        <span class="price">$139.00</span>
                                    </div>
                                </div>
                            </div>
