...
class PaginasTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $paginaSobre->titulo = "Arrudal Calçados";
        $paginaSobre->descricao = "A Arruda Calçados é uma empresa jovem que busca atender o genero feminino.";
        $paginaSobre->texto = "Buscamos trazer para o mercado os últimos lançamentos e tendencia para que você possa ficar sempre na moda.";
